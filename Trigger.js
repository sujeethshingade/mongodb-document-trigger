// MongoDB Change Stream Trigger for Audit Logging
exports = async function(changeEvent) {
    try {
        ...
        const logsCollection = context.services.get("mongodb-document-trigger").db("test").collection(`${collectionName}_logs`); // Adjust cluster name and database name as needed
