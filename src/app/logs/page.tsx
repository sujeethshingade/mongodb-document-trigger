...
export default function LogsPage({ }: LogsPageProps) {
    ...
    const [sortOrder, setSortOrder] = useState<'asc' | 'desc'>('desc');    // Fetch available collections
    ...
    }, [selectedCollection, pagination.limit, pagination.skip, filters, sortBy, sortOrder]); useEffect(() => {
